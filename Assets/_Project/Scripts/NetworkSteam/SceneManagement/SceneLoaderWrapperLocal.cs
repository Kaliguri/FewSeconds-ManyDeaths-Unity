...
public class SceneLoaderWrapperLocal : NetworkBehaviour
{
    /// <summary>
    ...
    [SerializeField]
    ClientLoadingScreenLocal m_ClientLoadingScreen;

    [SerializeField]
    LoadingProgressManagerLocal m_LoadingProgressManager;

    bool IsNetworkSceneManagementEnabled => NetworkManager.Singleton != null && NetworkManager.Singleton.SceneManager != null && NetworkManager.Singleton.NetworkConfig.EnableSceneManagement;

    bool m_IsInitialized;

    public static SceneLoaderWrapperLocal Instance { get; protected set; }
    ...
    public virtual void Start()
    {
        ...
        NetworkManager.Singleton.OnServerStarted += OnNetworkingSessionStarted;
        NetworkManager.Singleton.OnClientStarted += OnNetworkingSessionStarted;
        NetworkManager.Singleton.OnServerStopped += OnNetworkingSessionEnded;
        NetworkManager.Singleton.OnClientStopped += OnNetworkingSessionEnded;
    }
    ...
    public virtual void LoadScene(string sceneName, bool useNetworkSceneManager, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
    {
        ...
        {
            if (IsSpawned && IsNetworkSceneManagementEnabled && !NetworkManager.Singleton.ShutdownInProgress)
            {
            ...
            case SceneEventType.Synchronize: // Server told client to start synchronizing scenes
                {
                    ...
                    {
                        if (NetworkManager.Singleton.SceneManager.ClientSynchronizationMode == LoadSceneMode.Single)
                        {
